<template>
  ...
  >
    ...
    <clickable-image
      ...
      description="One of the rare pictures of the Audi A3. RIP (yeah she got scrapped)"
    ></clickable-image>
    <p>
    ...
    <clickable-image
      ...
      description="The Lexus close to its natural habitat: the Swiss Touge"
    ></clickable-image>
    <p>
...
export default {
  components: { ArticleShell, ClickableImage },
  data() {
    return {
