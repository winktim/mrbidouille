<template>
  ...
  >
    ...
    <p>
      <span
        >Because yes, if you hadn't noticed by now, this blog is actually </span
      ><span>bilingual. </span
      ><span
        >What it means is the interface is in English, because to me, it is an
        international language, and the articles are w</span
      ><span>ritten</span
      ><span>
        in the two languages that I know, which are French and English.</span
      >
    </p>
    <p>
      <span>And when I say “know”, </span
      ><span>don’t get me wrong! I don’t actually pretend to know e</span
      ><span>ither</span
      ><span>
        of those languages! I’ll probably make plenty of mistakes, some funnier
        than others.</span
      >
    </p>
    <p>
      <span
        ...
        but I learned it in school (naah, mostly on the internet). So I might
        not actually use the language like it was meant to be, and I might be
        i</span
      ><span>nfluenced</span
      ><span>
        by American English, Australian English, Japanese Enlgish (wtf?)…</span
      >
    </p>
    <p><br /></p>
    <p>
      <span>Well then to the point. I’m a 20 years old Swiss c</span
      ><span>heese</span
      ><span>
        that likes tech. More recently, since I got my driving license 2 years
        ago (yeah man, got it at 18, you know how it is). I know I just ended a
        sentence that wasn’t finished, but I need to make a little
        digression.</span
      >
    </p>
    <p><br /></p>
    ...
    <p>
      ...
      <nuxt-link to="/fr/2020-04-01-introduction">I said in French</nuxt-link>,
    ...
    <figure>
      <a href="/images/articles/2020-04-01-introduction/audi.jpg"
        ><img
          src="/images/articles/2020-04-01-introduction/audi.jpg"
          alt="Picture of the Audi A3"
      /></a>
      <span>
        One of the rare pictures of the Audi A3. RIP (yeah she got scrapped)
      </span>
    </figure>
    <p>
      <span>I first got </span><span>interested</span><span> i</span
      ><span>n </span
      ><span
        >performance driving. Then, (ironically just like Takumi in Initial D) I
        realized that knowing what was happening under the hood would be of
        great help to keep going forward in this domain.</span
      >
    </p>
    <p>
    ...
    <ul>
      ...
      <li>Japanese</li>
      <li>90’ car (designed in 1998)</li>
      <li>At least a 4 seater (she’s a 5)</li>
    </ul>
    ...
    <p>
      <span
        ...
        I’ll develop kits and other useful things for my car and maybe other
        cars in the future. You’ll hear more in the coming months. I’m currently
        in the process of testing my first kit, which I hope will be useful
        z</span
      ><span>o</span
      ><span>
        many people. As a teaser, I’m working on the problem of the slow
        electric throttle body of the IS200. I won’t say more for now!</span
      >
    </p>
    <p><br /></p>
    <p>
    ...
    <p>
      ...
      <span class="text-sm text-gray-300"
        >(It’s my username. If you have no idea what it means, check out
        <nuxt-link to="/about">the “About” page</nuxt-link>)</span
      >
    </p>
  </article-shell>
</template>
...
export default {
  ...
  data() {
    return {
      article: articles.en['2020-04-01-introduction'],
    }
  },
}
</script>
